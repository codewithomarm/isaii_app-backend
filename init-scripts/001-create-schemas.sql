...
GRANT ALL PRIVILEGES ON SCHEMA order TO isaii_postgre_admin;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA order GRANT ALL PRIVILEGES ON TABLES TO isaii_postgre_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA order GRANT ALL PRIVILEGES ON SEQUENCES TO isaii_postgre_admin;
