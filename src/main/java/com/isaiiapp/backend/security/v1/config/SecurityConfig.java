...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/order-items").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.PUT, "/v1/order-items/**").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.PATCH, "/v1/order-items/{id}/quantity").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.PATCH, "/v1/order-items/{id}/unit-price").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.PATCH, "/v1/order-items/{id}/instructions").hasAnyRole("ADMIN", "HOST", "COOK")
                        .requestMatchers(HttpMethod.DELETE, "/v1/order-items/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/v1/order-items/**").hasAnyRole("ADMIN", "HOST", "COOK")
                        .requestMatchers(HttpMethod.GET, "/v1/order-items/product/**").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.GET, "/v1/order-items/count/product/**").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.GET, "/v1/order-items/total-quantity/product/**").hasAnyRole("ADMIN", "HOST")
                        .requestMatchers(HttpMethod.GET, "/v1/order-items/most-ordered-products").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5500")); // cambia esto según tu dominio real
